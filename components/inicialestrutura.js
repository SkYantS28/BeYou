...
const PerfilLink = styled(IconLinkBase)``;
const NoticacaoLink = styled(IconLinkBase)``;
...
const PromocaoLugares = styled.div`${scrollWrapper}`;
const PromocaoProdutos = styled.div`${scrollWrapper}`;
const LogosEmpresas = styled.div`${scrollWrapper}`;
const VoceSabia = styled.div`${scrollWrapper}`;
...
const LugaresImg = styled.img`${baseImgStyle}`;
const PromocaoImg = styled.img`${baseImgStyle}`;
const ProdutosImg = styled.img`${baseImgStyle}`;
const VoceSabiaImg = styled.img`${baseImgStyle}`;
